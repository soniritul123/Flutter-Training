...
class _MySliderExample2State extends State<MySliderExample2> {
  ...
  void changeColor() {
    // Color? redcolorname = Color.fromRGBO(red, green, blue, 1);
    // Color? greencolorname = Color.fromRGBO(red, green, blue, 1);
    // Color? bluecolorname = Color.fromRGBO(red, green, blue, 1);
